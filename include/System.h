...
#include "yolov5/yolov5_config.h"
...
public:
    ...
    // Save point and line features shown in pangolin
    void SaveMapFeatures(const string &filename);
    void SaveMapFeatures2D(const string &filename);
...
private:
    ...
    // YOLOv5 settings, including model type, detector
    yolov5::Yolov5Type mYoloType;
